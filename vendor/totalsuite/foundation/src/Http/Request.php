...
use TotalRatingVendors\Psr\Http\Message\ServerRequestInterface;
use TotalRatingVendors\Psr\Http\Message\StreamInterface;
use TotalRatingVendors\Psr\Http\Message\UploadedFileInterface;
use TotalRatingVendors\Psr\Http\Message\UriInterface;
use RuntimeException;
use TotalRatingVendors\TotalSuite\Foundation\Exceptions\InvalidMethodException;
use TotalRatingVendors\TotalSuite\Foundation\Helpers\Concerns\ResolveFromContainer;
use TotalRatingVendors\TotalSuite\Foundation\Http\Concerns\Shorthands;
...
class Request extends Message implements ServerRequestInterface
{
     ...
     * an instance of TotalRatingVendors\Psr\Http\Message\UploadedFileInterface.
     *
