...
use Closure;
use TotalRatingVendors\Rakit\Validation\Rules\Interfaces\BeforeValidate;
use TotalRatingVendors\Rakit\Validation\Rules\Interfaces\ModifyValue;
use TotalRatingVendors\Rakit\Validation\Rules\Required;
...
class Validation
{
     ...
     * Constructor
     *
     * @param \TotalRatingVendors\Rakit\Validation\Validator $validator
     * @param array $inputs
     * @param array $rules
     ...
     *
     * @param string $attributeKey
     * @return null|\TotalRatingVendors\Rakit\Validation\Attribute
     */
     ...
     *
     * @return \TotalRatingVendors\Rakit\Validation\ErrorBag
     */
     ...
     * Validate attribute
     *
     * @param \TotalRatingVendors\Rakit\Validation\Attribute $attribute
     * @return void
     */
     ...
     * @param \TotalRatingVendors\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \TotalRatingVendors\Rakit\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     *
     * @param \TotalRatingVendors\Rakit\Validation\Attribute $attribute
     * @param \TotalRatingVendors\Rakit\Validation\Rule $rule
     * @return bool
     */
     ...
     * @param \TotalRatingVendors\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \TotalRatingVendors\Rakit\Validation\Rule $validator
     * @return mixed
     */
     ...
     *
     * @return \TotalRatingVendors\Rakit\Validation\Validator
     */
