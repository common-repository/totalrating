...
use TotalRatingVendors\League\MimeTypeDetection\FinfoMimeTypeDetector;
use TotalRatingVendors\League\MimeTypeDetection\GeneratedExtensionToMimeTypeMap;
use TotalRatingVendors\League\MimeTypeDetection\MimeTypeDetector;
