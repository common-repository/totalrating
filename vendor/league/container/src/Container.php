...
namespace TotalRatingVendors\League\Container;
! defined( 'ABSPATH' ) && exit();


use TotalRatingVendors\League\Container\Definition\{DefinitionAggregate, DefinitionInterface, DefinitionAggregateInterface};
use TotalRatingVendors\League\Container\Exception\{NotFoundException, ContainerException};
use TotalRatingVendors\League\Container\Inflector\{InflectorAggregate, InflectorInterface, InflectorAggregateInterface};
use TotalRatingVendors\League\Container\ServiceProvider\{
    ServiceProviderAggregate,
    ServiceProviderAggregateInterface,
    ServiceProviderInterface
};
use TotalRatingVendors\Psr\Container\ContainerInterface;
