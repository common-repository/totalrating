...
use Generator;
use TotalRatingVendors\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use TotalRatingVendors\League\Container\Exception\ContainerException;
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\TotalRatingVendors\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
