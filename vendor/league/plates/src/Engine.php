...
namespace TotalRatingVendors\League\Plates;
! defined( 'ABSPATH' ) && exit();


use TotalRatingVendors\League\Plates\Extension\ExtensionInterface;
use TotalRatingVendors\League\Plates\Template\Data;
use TotalRatingVendors\League\Plates\Template\Directory;
use TotalRatingVendors\League\Plates\Template\FileExtension;
use TotalRatingVendors\League\Plates\Template\Folders;
use TotalRatingVendors\League\Plates\Template\Func;
use TotalRatingVendors\League\Plates\Template\Functions;
use TotalRatingVendors\League\Plates\Template\Name;
use TotalRatingVendors\League\Plates\Template\ResolveTemplatePath;
use TotalRatingVendors\League\Plates\Template\Template;
use TotalRatingVendors\League\Plates\Template\Theme;
